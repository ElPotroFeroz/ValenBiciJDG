            ...
            if (entity != null) {
                ...
                try {
                    ...
                    for(int i=0;i<resultsArray.length();i++) {
                        ...
                        JSONObject jobj = resultsArray.getJSONObject(i); // Obtener el objeto actual
                        String adress = jobj.getString("address");
                        int disponibles = jobj.getInt("available");
                        int libres = jobj.getInt("free");
                        System.out.println(adress + " Disponibles: " + disponibles + " Libres: " + libres);
